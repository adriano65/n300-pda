...
static int n311_set_jack(struct snd_kcontrol*, struct snd_ctl_elem_value*);
static void n311_ext_control(struct snd_soc_codec *);
...
static int n311_get_spk(struct snd_kcontrol *kcontrol,
                          struct snd_ctl_elem_value *ucontrol)
{
        ucontrol->value.integer.value[0] = n311_spk_func;
        return 0;
}
