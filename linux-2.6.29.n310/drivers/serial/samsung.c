				       ...
				       struct ktermios *old)
{
	...
	/*baud = uart_get_baud_rate(port, termios, old, 0, 115200*8); */ // cxlabs
...
s3c24xx_serial_console_setup(struct console *co, char *options)
{
	...
	// cxlabs --> this call broke serial console...
	return uart_set_options(port, co, baud, parity, bits, flow);	//see serial_core.c
	//return 0;
}
