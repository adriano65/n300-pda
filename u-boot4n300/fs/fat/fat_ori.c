...
read_bootsectandvi(boot_sector *bs, volume_info *volinfo, int *fatsize)
{
	...
	FAT_DPRINT("vistart->fs_type[0] 0x%08x\n",vistart->fs_type[0]);
	FAT_DPRINT("vistart->fs_type[1] 0x%08x\n",vistart->fs_type[1]);
	FAT_DPRINT("vistart->fs_type[2] 0x%08x\n",vistart->fs_type[2]);
	FAT_DPRINT("vistart->fs_type[3] 0x%08x\n",vistart->fs_type[3]);
	FAT_DPRINT("vistart->fs_type[4] 0x%08x\n",vistart->fs_type[4]);
	FAT_DPRINT("vistart->fs_type[5] 0x%08x\n",vistart->fs_type[5]);
	FAT_DPRINT("vistart->fs_type[6] 0x%08x\n",vistart->fs_type[6]);
	FAT_DPRINT("vistart->fs_type[7] 0x%08x\n",vistart->fs_type[7]);
	return -1;
}
...
file_fat_detectfs(void)
{
	...
	switch(cur_dev->if_type) {
		...
		case IF_TYPE_SDHC :	printf("SDHC"); break;
