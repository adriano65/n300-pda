 ...
 *
 ...
 2. copy u-boot (NAND VERSION! not RAM one) to superipl.bin
...
#define CONFIG_BOOTARGS		"root=/dev/mmcblk0p3 rootdelay=2 rootfstype=ext3 console=tty0 console=ttySAC0,115200n8"
